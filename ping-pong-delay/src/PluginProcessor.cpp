...
{
    // TODO: remove your event listeners
...
juce::AudioProcessorValueTreeState::ParameterLayout AudioPluginAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterChoice>("mode", "Mode", juce::StringArray({"center", "left", "right"}), 0));
...
void AudioPluginAudioProcessor::parameterChanged(const juce::String &id, float newValue)
{
    ...
    {
        delay.set_mode(static_cast<int>(newValue));
    }
}
...
void AudioPluginAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
    ...
    delay.set_mode(static_cast<int>(*parameters.getRawParameterValue("mode")));
}
